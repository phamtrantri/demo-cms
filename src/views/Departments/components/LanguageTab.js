...
function LanguageTab(props) {
  ...
  return (
    <Fragment>
      ...
      <Field
        labelText={t('function')}
        id={`contents.${index}.function`}
        name={`contents.${index}.function`}
        component={InputWrapper}
        inputProps={{
          multiline: true,
          rows: 5
      ...
      <Field
        labelText={t('mission')}
        id={`contents.${index}.mission`}
        name={`contents.${index}.mission`}
        component={InputWrapper}
        inputProps={{
          multiline: true,
          rows: 5
      ...
      <Field
        labelText={'Bài đăng giới thiệu chuyên khoa'}
