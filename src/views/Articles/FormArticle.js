...
import { article, category, language, auth } from 'reducers';
...
function FormArticle(props) {
  ...
  const defaultType = CATEGORY_TYPE.OTHERS;
  ...
  const internationalTypes = [
    { value: 1, label: 'Tin trong nước' },
    { value: 0, label: 'Tin nước ngoài' }
  ];
            ...
            <Card className={classes.cardMB}>
              <CardHeader color="primary">
                <h4 className={classes.cardTitleWhite}>
                  {data._id ? t('updateArticle') : t('addArticle')}
                </h4>
              </CardHeader>
              <CardBody>
                <GridContainer>
                ...
                <GridContainer>
                  ...
                  <GridItem xs={6}>
                    <Field
                      labelText={'Loại tin'}
                      id="international_type"
                      name="international_type"
                      component={SelectWrapper}
...
export default compose(...enhancers)(FormArticle);
