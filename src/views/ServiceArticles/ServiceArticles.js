...
import { articleService, app } from 'reducers';
...
function ServiceArticles(props) {
        ...
        actions={[
          {
            ...
            tooltip: t('add'),
            isFreeAction: true,
            onClick: () => history.push(`/admin/service-articles/create`)
          },
          // {
          //   icon: 'filter_list',
          //   tooltip: 'Add User',
          ...
          // },
          {
            ...
            tooltip: t('update'),
            onClick: (e, rowData) =>
              history.push(`/admin/service-articles/update?id=${rowData._id}`),
            position: 'row'
          },
          {
            icon: 'delete',
...
const mapStateToProps = createStructuredSelector({
  articles: articleService.selectors.items,

  isLoading: createSelector(
    articleService.selectors.isLoadingItems,
    articleService.selectors.isUpdating,
    articleService.selectors.isDeleting,
...
const mapDispatchToProps = {
  getArticles: articleService.actions.articleServiceGetAllAjax,

  updateArticle: articleService.actions.articleServiceUpdateAjax,

  deleteArticle: articleService.actions.articleServiceDeleteAjax,

  cancel: articleService.actions.articleServiceGetAllCancelled,
...
export default compose(...enhancers)(ServiceArticles);
