...
import { articleIntro, category, language, auth } from 'reducers';
...
function FormIntro(props) {
  ...
  const defaultType = CATEGORY_TYPE.INTRO;
            ...
            <Card className={classes.cardMB}>
              <CardHeader color="primary">
                <h4 className={classes.cardTitleWhite}>
                  {data._id ? t('updateIntro') : t('addIntro')}
                </h4>
              </CardHeader>
              <CardBody>
                <Field
...
const mapStateToProps = createStructuredSelector({
  ...
  data: articleIntro.selectors.item,

  user: auth.selectors.user,

  isLoading: createSelector(
    articleIntro.selectors.isLoadingItem,
    articleIntro.selectors.isInserting,
...
const mapDispatchToProps = {
  ...
  getArticle: articleIntro.actions.articleIntroGetAjax,

  addArticle: articleIntro.actions.articleIntroInsertAjax,

  updateArticle: articleIntro.actions.articleIntroUpdateAjax,

  cleanArticle: articleIntro.actions.articleIntroGetClean
};
