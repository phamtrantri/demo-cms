...
import { articleProcess, category, language, auth } from 'reducers';
...
function FormProcess(props) {
  ...
  const defaultType = CATEGORY_TYPE.QUY_TRINH;
  ...
  return (
    ...
    >
      {({ values: { language, thumbnail_image }, setFieldValue }) => {
        return (
          <Form>
            <Card className={classes.cardMB}>
              <CardHeader color="primary">
                <h4 className={classes.cardTitleWhite}>
                  {data._id ? t('updateProcess') : t('addProcess')}
                </h4>
              </CardHeader>
              <CardBody>
                <Field
...
const mapStateToProps = createStructuredSelector({
  ...
  data: articleProcess.selectors.item,

  user: auth.selectors.user,

  isLoading: createSelector(
    articleProcess.selectors.isLoadingItem,
    articleProcess.selectors.isInserting,
...
const mapDispatchToProps = {
  ...
  getArticle: articleProcess.actions.articleProcessGetAjax,

  addArticle: articleProcess.actions.articleProcessInsertAjax,

  updateArticle: articleProcess.actions.articleProcessUpdateAjax,

  cleanArticle: articleProcess.actions.articleProcessGetClean
};
...
export default compose(...enhancers)(FormProcess);
