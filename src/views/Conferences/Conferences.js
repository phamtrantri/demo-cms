...
import { articleConference, app } from 'reducers';
        ...
        actions={[
          {
            ...
            tooltip: t('add'),
            isFreeAction: true,
            onClick: () => history.push('/admin/scientific-conferences/create')
          },
          // {
          //   icon: 'filter_list',
          //   tooltip: 'Add User',
          ...
          // },
          {
            ...
            onClick: (e, rowData) =>
              history.push(
                `/admin/scientific-conferences/update?id=${rowData._id}`
              ),
            position: 'row'
          },
          {
...
const mapStateToProps = createStructuredSelector({
  articles: articleConference.selectors.items,

  isLoading: createSelector(
    articleConference.selectors.isLoadingItems,
    articleConference.selectors.isUpdating,
    articleConference.selectors.isDeleting,
...
const mapDispatchToProps = {
  getArticles: articleConference.actions.articleConferenceGetAllAjax,

  updateArticle: articleConference.actions.articleConferenceUpdateAjax,

  deleteArticle: articleConference.actions.articleConferenceDeleteAjax,

  cancel: articleConference.actions.articleConferenceGetAllCancelled,
...
export default compose(...enhancers)(Conferences);
