...
import { articleConference, category, language, auth } from 'reducers';
...
function FormIntro(props) {
  ...
  const defaultType = CATEGORY_TYPE.HOI_NGHI_KHOA_HOC;
            ...
            <Card className={classes.cardMB}>
              <CardHeader color="primary">
                <h4 className={classes.cardTitleWhite}>
                  {data._id ? t('updateConference') : t('addConference')}
                </h4>
              </CardHeader>
              <CardBody>
                <Field
                ...
                <GridContainer>
                  <GridItem xs={6}>
                    <Field
                      ...
                      name="status"
                      component={SelectWrapper}
                      options={articleConferenceStatus}
...
const mapStateToProps = createStructuredSelector({
  ...
  data: articleConference.selectors.item,

  user: auth.selectors.user,

  isLoading: createSelector(
    articleConference.selectors.isLoadingItem,
    articleConference.selectors.isInserting,
    articleConference.selectors.isUpdating,
...
const mapDispatchToProps = {
  ...
  getArticle: articleConference.actions.articleConferenceGetAjax,

  addArticle: articleConference.actions.articleConferenceInsertAjax,

  updateArticle: articleConference.actions.articleConferenceUpdateAjax,

  cleanArticle: articleConference.actions.articleConferenceGetClean
};
...
export default compose(...enhancers)(FormIntro);
