...
import { articleQA, app } from 'reducers';
        ...
        actions={[
          {
            ...
            tooltip: t('add'),
            isFreeAction: true,
            onClick: () => history.push('/admin/question-answers/create')
          },
          // {
          //   icon: 'filter_list',
          //   tooltip: 'Add User',
          ...
          // },
          {
            ...
            tooltip: t('update'),
            onClick: (e, rowData) =>
              history.push(`/admin/question-answers/update?id=${rowData._id}`),
            position: 'row'
          },
          {
            icon: 'delete',
...
const mapStateToProps = createStructuredSelector({
  articles: articleQA.selectors.items,

  isLoading: createSelector(
    articleQA.selectors.isLoadingItems,
    articleQA.selectors.isUpdating,
    articleQA.selectors.isDeleting,
...
const mapDispatchToProps = {
  getArticles: articleQA.actions.articleQaGetAllAjax,

  updateArticle: articleQA.actions.articleQaUpdateAjax,

  deleteArticle: articleQA.actions.articleQaDeleteAjax,

  cancel: articleQA.actions.articleQaGetAllCancelled,
...
export default compose(...enhancers)(QAs);
