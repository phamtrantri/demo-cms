...
function ChangePassword(props) {
  ...
  const handleSubmit = (v, bag) => {
    ...
    props.changePassword({ params, onSuccess });
  };
        ...
        <Form>
          <Card className={classes.cardMB}>
            <CardHeader color="primary">
              <h4 className={classes.cardTitleWhite}>{t('changePassword')}</h4>
            </CardHeader>
            <CardBody>
              <Field
...
const mapDispatchToProps = {
  changePassword: auth.actions.changePasswordAjax
};
...
export default compose(...enhancers)(ChangePassword);
